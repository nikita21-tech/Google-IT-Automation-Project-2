...
def process_data(data):
  ...
  for item in data:
    ...
    if not item["car"]["car_year"] in car_sales.keys():
        car_sales[item["car"]["car_year"]] = item["total_sales"]
    else:
        car_sales[item["car"]["car_year"]] += item["total_sales"]

    all_values = car_sales.values()
    max_value = max(all_values)
    max_key = max(car_sales, key= car_sales.get)
...
# TODO: turn this into a PDF report
  ...
  message = email_generate('automation@example.com', 'student-04-6ec1eb715044@example.com', 'Sales summary for last month', new_summary, '/tmp/cars.pdf')
  email_send(message)
